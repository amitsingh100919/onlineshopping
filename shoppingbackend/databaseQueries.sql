...
INSERT INTO category(name,description,image_url,is_active) VALUES('Mobile','This is description for mobile cateory','CAT_1.png',true);
INSERT INTO category(name,description,image_url,is_active) VALUES('Laptop','This is description for laptop cateory','CAT_2.png',true);
INSERT INTO category(name,description,image_url,is_active) VALUES('Television','This is description for television cateory','CAT_3.png',true);
...
VALUES('Virat', 'kohli', 'ADMIN', true, 'admin', 'vk@gmail.com','1234567891');

INSERT INTO user_detail
(first_name, last_name, role, enable, password, email, contact_number)
VALUES('Raj', 'singh', 'SUPPLIER', true, '12345', 'rs@gmail.com','1234567892');

INSERT INTO user_detail
(first_name, last_name, role, enable, password, email, contact_number)
VALUES('Rahul', 'kumar', 'SUPPLIER', true, '345221', 'rk@gmail.com','1234567893');
