package com.amitsingh.shoppingbackend.test;
...
import com.amitsingh.shoppingbackend.dao.ProductDAO;
import com.amitsingh.shoppingbackend.dto.Product;
...
public class ProductTestCase {
	...
	public static void init() {
		...
		context.scan("com.amitsingh.shoppingbackend");
		context.refresh();
	...
	public void testCRUDProduct() {
		...
		product.setName("moto x4");
		product.setBrand("motorola");
		product.setDescription("Its a mid rang smart phone");
		...
		assertEquals("Something went wrong while updating and exiting record",true,productDAO.update(product));
		
		assertEquals("Something went wrong while deleting and exiting record",true,productDAO.delete(product));
